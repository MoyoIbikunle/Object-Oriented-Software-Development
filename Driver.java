...
public class Driver
{
  	...
  	{ 
  		...
  		Triangle    triangle = new Triangle ("Triangle One", "Purple", 10, 5 );
		...
		shape = triangle;
  		...
  		System.out.println("Sphere volume = " + threeDShape.volume());  //polymorphic call using superclass reference
  	}
}